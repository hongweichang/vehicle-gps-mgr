...
*/
	...
	*/
	...
	function  resolvingDirection($cur_direction=-1){
		...
		$arr_direction =array("north","northeast","east","southeast","south","southwest","west","northwest");
     ...
     */
		function convertOverlongString($Str, $Length) {//$Str为截取字符串，$Length为需要截取的长度 
