...
jQuery("#navgrid2").jqGrid({
   	url:'index.php?a=1002&role=system',
		datatype: "json",
   	colNames:['ID','登录用户名','密码','用户名','所属公司','公司','角色ID','邮箱','状态','角色'],
   	colModel:[
   		...
   		{name:'company_name',index:'company_name', width:60,align:"center",editable:true,editoptions:{size:10}},
   		...
   		{name:'role',index:'role', width:50, align:"center",editable:true,editrules:{required:true},edittype:"select",editoptions:{dataUrl:'index.php?a=1008&p=sys_role'}}
