...
jQuery("#navgrid2").jqGrid({
   	...
   	colModel:[
   		...
   		{name:'login_name',index:'login_name', width:80,editable:true,editrules:{required:true},editoptions:{size:10}},
   		{name:'password',index:'password', width:40,hidden:true,editrules:{required:true,edithidden:true},editable:true,editoptions:{size:25}},
   		{name:'name',index:'name', width:60, align:"right",editrules:{required:true},editable:true,editoptions:{size:10}},
   		...
   		{name:'email',index:'email', width:50, align:"right",editable:true,editrules:{required:false,email:true},editoptions:{size:10}},
