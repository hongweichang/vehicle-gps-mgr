jQuery("#navgrid_company").jqGrid({
	...
	colNames:['ID','登录id', '公司名', '公司注册号','地区1(省)','地区2(市)','地区3(区、县)','描述','联系人名字','地址','邮编','电话','传真','移动电话','邮箱','网址','状态','服务开始时间','服务结束时间','收费标准','创建人','创建时间','更新人','更新时间'],
   	colModel:[
		...
		{name:'register_num',index:'register_num', width:55,align:"center",editable:true,editoptions:{size:20,maxlength:20}},
		...
		{name:'email',index:'email', width:55,align:"center",editable:true,editoptions:{size:30,maxlengh:30}},
