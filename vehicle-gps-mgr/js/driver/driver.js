...
//   		{name:'id',index:'id', width:55,align:"center",editable:false,editoptions:{readonly:true,size:10}},
   		{name:'name',index:'name',width:80,align:"center",editable:true,editoptions:{size:20},formoptions:{elmsuffix:"(*)"},editrules:{required:true}},
   		{name:'driving_licence_id',index:'driving_licence_id', width:90,align:"center",editable:true,editoptions:{size:18,maxlength:18}},
...
//   		{name:'company_id',index:'company_id', width:60,align:"right",editable:true,editoptions:{size:10}},
		...
		{name:'job_number',index:'job_number',width:70,align:'center', editable: true,editoptions:{size:10,maxlength:20}},
   		{name:'driving_type',index:'driving_type', width:60, align:'center', editable: true,editoptions:{size:10},edittype:"select",editoptions:{dataUrl:'index.php?a=5012&par=driver_manage&child=driving_type'}},
