jQuery("#navgrid_vehicle").jqGrid({
   	...
   	colModel:[
   		...
   		{name:'driver_id',index:'driver_id', width:60, align:"right",editable:true,editoptions:{size:10}},
   		{name:'type_id',index:'type_id', width:60, align:"right",editable:true,editoptions:{size:10}},
