...
jQuery("#navgrid_vehicle").jqGrid({
   	...
   	colModel:[
   		...
   		{name:'number_plate',index:'number_plate', width:80,editable:true,editrules:{required:true},editoptions:{size:10}},
   		{name:'gps_id',index:'gps_id', width:60,editable:true,editrules:{required:true},editoptions:{size:25}},
   		{name:'vehicle_group_id',index:'vehicle_group_id', width:60, align:"right",editrules:{required:true},editable:true,edittype:"select",editoptions:{dataUrl:'index.php?a=1013&p=vehicle_group_id'}},
   		{name:'driver_id',index:'driver_id', width:60, align:"right",editable:true,editrules:{required:true},edittype:"select",editoptions:{dataUrl:'index.php?a=1013&p=driver_id'}},
   		{name:'type_id',index:'type_id', width:60, align:"right",editable:true,edittype:"select",editrules:{required:true},editoptions:{dataUrl:'index.php?a=1013&p=type_id'}},
