...
CREATE TABLE `common_setting` (
  ...
  `speed_limit` float default NULL COMMENT '超速限制(例120公里/h)',
...
INSERT INTO `company` VALUES (1, '1', '公司2', '1', '0', '0', '0', '描述', '联系人', '北京市', '10000', '15001095653', '010-11111111', '15001095653', 'suyuanyuan.87@163.com', 'www.baidu.com', 1, '2010-07-27 11:23:54', '2010-07-15 05:17:27', '100元/小时', 1, '2010-07-30 16:09:22', 1, '2010-07-30 16:09:22');
...
INSERT INTO `login_log` VALUES (1, 1, 1, '127.0.0.1', '2010-08-01 17:13:22', NULL);
INSERT INTO `login_log` VALUES (2, 1, 1, '127.0.0.1', NULL, '2010-08-01 17:13:36');
INSERT INTO `login_log` VALUES (3, 1, 1, '127.0.0.1', '2010-08-01 17:13:43', NULL);
...
CREATE TABLE `module` (
  ...
  `effective_flag` tinyint(1) NOT NULL COMMENT '有效标志',
  `create_id` int(11) default NULL COMMENT '创建人',
  `create_time` datetime default NULL COMMENT '创建时间',
  `update_id` int(11) default NULL COMMENT '更新人',
  `update_time` datetime default NULL COMMENT '更新时间',
...
INSERT INTO `module` VALUES (1006, 'system_set', 'admin/system_set', '系统设置管理', 6, 1, 1, '2010-07-26 10:36:23', 1, '2010-07-26 10:36:36');
...
CREATE TABLE `module_function` (
  ...
  `update_time` datetime default NULL COMMENT '更新时间',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=5017 ;
...
CREATE TABLE `vehicle_manage` (
  ...
  `location_time` datetime default NULL COMMENT '当前定位时间',
